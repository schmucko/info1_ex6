...
class Thesis(Module):
    def __init__(self, ects, title, semester, topic, research_group=None, grade=None):
        Module.__init__(self, ects, title, semester, grade)
        self.research_group = research_group
        self.topic = topic

    def __str__(self):
        return str(" {} on the topic: {} in the Research Group {}" .format(self.title, self.topic, self.research_group))
